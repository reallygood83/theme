          ...
          <Card title="❓ 자주 묻는 질문 (FAQ)">
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-green-400">
                <h3 className="font-semibold mb-2 text-gray-800">Q: 몇 명의 학생이 세션에 참여할 수 있나요?</h3>
                <p className="text-gray-600 text-sm">
              ...
              <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-purple-400">
                <h3 className="font-semibold mb-2 text-gray-800">Q: 이전에 진행한 세션을 다시 확인할 수 있나요?</h3>
                <p className="text-gray-600 text-sm">
              ...
              <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-orange-400">
                <h3 className="font-semibold mb-2 text-gray-800">Q: AI가 추천한 논제를 수정할 수 있나요?</h3>
                <p className="text-gray-600 text-sm">
              ...
              <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-indigo-400">
                <h3 className="font-semibold mb-2 text-gray-800">Q: 학생들의 부적절한 질문이나 검색이 걱정됩니다.</h3>
                <p className="text-gray-600 text-sm">
              ...
              <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-pink-400">
                <h3 className="font-semibold mb-2 text-gray-800">Q: 근거자료 검색 기능은 어떻게 작동하나요?</h3>
                <p className="text-gray-600 text-sm">
                  A: AI가 토론 주제와 입장(찬성/반대)에 맞는 뉴스 기사, 유튜브 영상 등을 자동으로 검색하고 선별하여 제공합니다. 
                  모든 자료는 교육적 적합성을 검증한 후 제공됩니다.
                </p>
              </div>
            </div>
          </Card>
